          ...
          {activeTab === 'Timeline' && !selectedEntry && (
            <View>
              ...
              <View style={styles.grid}>
                {allKeys.map((key, i) => (
                  <Pressable key={key} style={styles.gridButton} onPress={() => setSelectedEntry(key)}>
...
const styles = StyleSheet.create({
  ...
  iconText: { fontSize: 16, color: '#3a2e1f' },
  tabIcon: { fontSize: 16, opacity: 0.4 },
  tabIconActive: { opacity: 1 },
  pages: { flex: 1, marginHorizontal: '18%', marginTop: '4%', marginBottom: '8%' },
  pageTitle: { fontSize: 16, fontWeight: 'bold', color: '#3a2e1f', marginBottom: 6 },
  pageIntro: { fontSize: 10, color: '#5a4a35', marginBottom: 10, fontStyle: 'italic' },
  ...
  gridButtonText: { color: '#3a2e1f', fontWeight: '600', fontSize: 11 },
  backLink: { color: '#8a6d3b', marginBottom: 8, fontWeight: '600', fontSize: 11 },
  entryBlock: { marginBottom: 10 },
  entryDate: { fontWeight: 'bold', color: '#3a2e1f', marginBottom: 3, fontSize: 11 },
  entryContent: { color: '#5a4a35', fontSize: 10, lineHeight: 14 },
});
